...
ClippingArea::ClippingArea():m_Stencil(NULL), m_boolClipping(true)
{
...
const CCSize ClippingArea::getClippingSize()
{
    return m_Stencil->getContentSize();
}


void ClippingArea::setClippingEnabled(bool enabled)
{
    m_boolClipping = enabled;
}


bool ClippingArea::isClipping()
{
    return m_boolClipping;
}
